...
namespace
{
constexpr float kMinConfiguredPower = 13.0f;
constexpr float kJudgeFallbackPower = 42.0f;
constexpr float kMaxCapPowerOut = 180.0f;
constexpr float kCapEnergyFullTarget = 1000.0f;
constexpr float kCapEnergyBaseTarget = 500.0f;
